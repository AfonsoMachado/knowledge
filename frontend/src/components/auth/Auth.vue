<template>
  <div class="auth-content">
    <div class="auth-modal">
      <img src="@/assets/base.png" alt="Logo" width="200" />
      <hr />
      ...
      <!-- PARA ALTERAR ENTRE AS TELAS SIGNIN E SIGNUP -->
...
export default {
  ...
  data: function () {
    return {
      // para alternar entre as telas de signin e signup
      showSignup: false,
      user: {},
    };
  },
